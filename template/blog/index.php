...
<!-- corner -->
		...
		<script type="text/javascript">
			$('#container').corner("bottom 5px");$('#headline-menu').corner("top 5px");
		</script>
<!-- ... corner -->
...
<body id="toc-top">
	...
	<div id="container">
				...
				<?php
				echo "<div id=\"right\"><h1>Topics</h1><ul>";
				echo buildmenuul();
				echo "</ul></div>";
				?>
	...
	<div id="footer"><?php echo date("d.m.Y H:i");?> &copy;<?php echo $page_title;?>: 
