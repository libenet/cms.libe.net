...
<style>#menu a {width: <?php echo floor(970/(1+substr_count(buildmenu("1","1","1"),"<div")));?>px;}</style>
</head>
<body id="toc-top">
<div id="header">
	<div id="logo">
...
<div id="page">
	...
	<div id="sidebar">
		<ul>
									<?php $menu=buildmenuul("1",$menuforlevel[1],"5"); if(!empty($menu) and $start!=1) echo "
										<li>
...
<div id="footer">
	<p>Copyright (c) <?php echo $page_title;?> All rights reserved. Design by <a href="http://www.freecsstemplates.org/">Free CSS Templates</a>. <a href="http://cms.libe.net">powered by cms.libe.net</a></p>
</div>
<!-- end #footer -->
</body>
</html>
